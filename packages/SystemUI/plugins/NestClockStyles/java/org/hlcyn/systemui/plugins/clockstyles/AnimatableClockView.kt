...
constructor(
    ...
    companion object {
        ...
        fun getLargeClockView(context: Context, clockId: String): AnimatableClockView {
            return AnimatableClockView(context).apply {
                ...
                textSize = resources.getDimension(
                    if (clockId == NEST_CLOCK_ID) R.dimen.single_line_large_clock_text_size
                    else R.dimen.large_clock_text_size
                )
                val fontRes = selectFont(clockId)
                if (fontRes != 0) {
                ...
                isSingleLineInternal = (clockId == NEST_CLOCK_ID)
        ...
        fun getLineSpaceByClockId(clockId: String): Int {
            return R.dimen.keyguard_clock_line_spacing_scale
        }
    }
}
